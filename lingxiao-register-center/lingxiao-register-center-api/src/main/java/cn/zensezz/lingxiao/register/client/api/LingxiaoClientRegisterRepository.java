...
package cn.zensezz.lingxiao.register.client.api;

import cn.zensezz.lingxiao.spi.Spi;
...
@Spi
public interface LingxiaoClientRegisterRepository {
    ...
    default void init(LingxiaoRegisterCenterConfig config) {
    }
