...
public interface ZookeeperPathConstants {
    ...
    static final String SELECTOR_PARENT = "/c/selector";

    static final String SELECTOR_JOIN_RULE = "-";

    static final String PLUGIN_PARENT = "/c/plugin";

     static final String RULE_PARENT = "/c/rule";

    static final String APP_AUTH_PARENT = "/c/auth";
