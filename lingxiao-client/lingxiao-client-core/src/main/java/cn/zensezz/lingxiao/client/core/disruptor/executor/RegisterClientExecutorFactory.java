...
package cn.zensezz.lingxiao.client.core.disruptor.executor;

import cn.zensezz.lingxiao.disruptor.consumer.QueueConsumerExecutor;
import cn.zensezz.lingxiao.disruptor.consumer.QueueConsumerFactory;
import cn.zensezz.lingxiao.springboot.starter.client.common.subsriber.ExecutorSubscriber;

public  class RegisterClientExecutorFactory implements QueueConsumerFactory {
        ...
        public String fixName() {
            return "lingixao_register_client";
        }
    }